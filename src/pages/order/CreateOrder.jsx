...
import { fetchFoods } from "../../pages/Slice/FoodSlice";
import { fetchOffers } from "../../pages/Slice/OfferSlice";
import { fetchTables } from "../../pages/Slice/TableSlice";
...
const CreateOrder = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchFoods(currentRestaurantId));
    dispatch(fetchOffers(currentRestaurantId));
    dispatch(fetchTables(currentRestaurantId));
  }, [dispatch, currentRestaurantId]);
  
  useEffect(() => {
    console.log('Active Offers from Redux:', activeOffers);
    console.log('Active Tables from Redux:', activeTables);
